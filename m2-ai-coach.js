    ...
    if (waitlistForm) {
        waitlistForm.addEventListener('submit', function(e) {
            ...
            const formData = {
                ...
                source: 'M2 AI Coach Landing Page'
            };
            
            // Basic validation
            if (!formData.firstName || !formData.email || !formData.interest || !formData.ageGroup) {
            ...
            // Store in localStorage (temporary solution until backend is set up)
            storeWaitlistData(formData);
